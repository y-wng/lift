#!/usr/bin/env bash
# LIFT sampling ablation: 1 offline sample for every 2 online samples.
#
...
export OPENPI_MIN_ONLINE_RATIO="0.6666666667"
export OPENPI_MAX_ONLINE_RATIO="0.6666666667"
export OPENPI_INITIAL_ONLINE_WEIGHT="0.6666666667"
config_name="${OPENPI_CONFIG_NAME:-pi05_iPhoneSingle_book_insertion_v3_100_reactive}"
export OPENPI_EXP_NAME="${OPENPI_EXP_NAME:-${config_name}_ratio_1to2_$(date -u +%Y%m%d_%H%M%S)}"
